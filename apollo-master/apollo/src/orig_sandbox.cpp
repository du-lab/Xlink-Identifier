...
//    }
    ...
    ResidueCount dynmModCount = apollo::fn::rCountFromSequence(*seq2, options.sequence().dynamicMods);

//    cout << "********** Testing make_geniter of MultiModCountGen ************" << endl;
//    auto test51 = make_geniter<apollo::MultiModCountGen>();
//    
//    auto test52 = make_geniter<apollo::MultiModCountGen>(options.sequence().dynamicMods, 
//                    dynmModCount);
//
//    test51 = test52;
//
//    cout << "********** Testing MultiModCountGen ************" << endl;
//    apollo::MultiModCountGen test54(options.sequence().dynamicMods, 
//                    dynmModCount);
//
//    apollo::MultiModCountGen test53(test54);
//    //apollo::MultiModCountGen test53;
//
//    test53 = test54;
//    apollo::MultiModCountGen test55(test54);
//    apollo::MultiModCountGen test56(test53);
//    apollo::MultiModCountGen test57(test53);
//
//    cout << "********** Testing make_geniter of SequenceMhGen ************" << endl;
//    auto test61 = make_geniter<apollo::SequenceMhGen>(*seq1, options.sequence());
//    auto test62 = make_geniter<apollo::SequenceMhGen>();
//
//    apollo::SequenceMhGen test63(*seq1, options.sequence());
//    auto test64 = make_geniter<apollo::SequenceMhGen>(test63);
//


    cout << "********** Testing mmod_range_t ************" << endl;
    typedef apollo::MultiModCountIter mmod_iter_t;
    typedef apollo::RangeIter<mmod_iter_t> mmod_range_t;

    mmod_range_t test71 = mmod_range_t( make_geniter<apollo::MultiModCountGen>());

    mmod_range_t test72 = mmod_range_t( make_geniter<apollo::MultiModCountGen>(options.sequence().dynamicMods, 
                    dynmModCount));


    mmod_range_t test74(test72);
    test71 = test74;
    test71 = test72;

    cout << "==================== End Owen Stuf =====================" << endl;
